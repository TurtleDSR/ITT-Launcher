...
public final class ImageManager {
  ...
  private static Image loadImageFile(String path) {
    ...
    if(is == null) {
      System.err.println("[IMAGEMANAGER]: Image file not found: " + path);
      return null;
    }

    try {return ImageIO.read(is);} catch(IOException e) {
      System.err.println("[IMAGEMANAGER]: There was a problem loading the image");
      System.err.println("[IMAGEMANAGER]: " + e.getMessage());
    }
